...
pub const Camera = struct {
    ...
    pub fn setPerspective(self: *Camera, fov_y: f32, aspect: f32, near: f32, far: f32) void {
        self.fov_y = fov_y;
        self.aspect = aspect;
        self.near = near;
        self.far = far;
    ...
    fn updateProjection(self: *Camera) void {
    ...
    pub fn translate(self: *Camera, offset: zm.Vec) void {
